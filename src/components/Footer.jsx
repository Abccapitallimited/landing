...
const Footer = () => {
  return (
    <footer className='bg-[#105C04] px-8 sm:px-24 py-12 text-[#BDBDBD] font-thin'>
      <div className='flex flex-col sm:flex-row justify-start  sm:justify-center text-left gap-8 py-24'>
        <div className='grow'>
        ...
        <div className='grow flex flex-col sm:flex-row sm:justify-between gap-8'>
          <ul className='flex flex-col gap-y-4'>
