...
const Properties = () => {
  return (
    <section className='px-8 lg:px-24 py-24 bg-[#FCF0DC]' id='properties'>
      ...
      <div className='flex items-center gap-x-4'>
        ...
        <div className='custom_grid items-center text-left gap-8 flex-wrap'>
          <div className='bg-[#105C04] rounded-2xl px-4 py-4 grow text-[#ffffff] min-w-[300px]'>
